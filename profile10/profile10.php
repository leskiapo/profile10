...
class PlgUserProfile10 extends JPlugin
{
	...
	public function onContentPrepareForm(Form $form, $data)
    {
		...
		{
			$form->setFieldAttribute('company', 'description', 'PLG_USER_PROFILE_FILL_FIELD_DESC_SITE', 'profile');
			...
			$form->setFieldAttribute('products_of_interest', 'description', 'PLG_USER_PROFILE_FILL_FIELD_DESC_SITE', 'profile');
